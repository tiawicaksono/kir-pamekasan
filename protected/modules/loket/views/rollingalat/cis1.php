    ...
    <tbody>
        ...
        foreach ($pengujicis1 as $cis1):
            ...
            <tr>
                ...
                <td class="center">
                    <input name="brake1[<?php echo $cis1->id_user; ?>]" type="checkbox" id="brake1-<?php echo $no; ?>" class="regular-checkbox" <?php echo $cis1->rem == 'true' ? "checked" : ""; ?> />
                    <label for="brake1-<?php echo $no; ?>"></label>
                </td>
                <td class="center">
                    <input name="headlight1[<?php echo $cis1->id_user; ?>]" type="checkbox" id="headlight1-<?php echo $no; ?>" class="regular-checkbox" <?php echo $cis1->lampu == 'true' ? "checked" : ""; ?> />
