<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th>PENGUJI</th>
            <th class="center">PRAUJI</th>
            <th class="center">EMISI</th>
            <th class="center">PIT LIFT</th>
            <th class="center">LAMPU</th>
    ...
    <tbody>
        ...
        foreach ($pengujicis2 as $cis2):
            ...
            <tr>
                ...
                <td class="center">
                    <input name="headlight2[<?php echo $cis2->id_user; ?>]" type="checkbox" id="headlight2-<?php echo $no; ?>" class="regular-checkbox" <?php echo $cis2->lampu == 'true' ? "checked" : ""; ?> /><label for="headlight2-<?php echo $no; ?>"></label>
                </td>
                <td class="center">
                    <input name="brake2[<?php echo $cis2->id_user; ?>]" type="checkbox" id="brake2-<?php echo $no; ?>" class="regular-checkbox" <?php echo $cis2->rem == 'true' ? "checked" : ""; ?> /><label for="brake2-<?php echo $no; ?>"></label>
                </td>
            </tr>
            <?php
            $no++;
