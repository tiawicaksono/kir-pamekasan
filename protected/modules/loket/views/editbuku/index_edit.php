            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        ...
                        <label for="nomer_sertifikasi_uji">Nomor Rekomendasi Numpang Uji Masuk</label>
                        ...
                        <label for="nomer_sertifikasi_rancang">Nomor Rekomendasi Mutasi Uji Masuk</label>
                        ...
                        <div class="col-md-7 no-margin no-padding">
                            ...
                            <?php echo CHtml::textField('diterbitkan_nomer_sertifikasi_rancang', '', array('class' => 'form-control text-besar', 'readonly' => true)) ?>
                        </div>
                        <div class="col-md-1 no-margin no-padding"></div>
                        <div class="col-md-4 no-margin no-padding">
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <?php // echo CHtml::textField('propinsi', 'JAWA TIMUR', array('class' => 'form-control text-besar')) 
                        ?>
                        <?php
                        ...
                        <?php // echo CHtml::textField('kota', 'PAMEKASAN', array('class' => 'form-control text-besar', 'onkeyup' => 'cekKecamatan()')) 
                        ?>
                        <?php
                        ...
                        echo CHtml::dropDownList('kota_select', '3528', $type_list, array('class' => 'kota_select form-control selectpicker show-tick wajib-isi', 'data-live-search' => 'true', 'data-size' => '5', 'onchange' => 'selectKota()'));
                        ?>
                        ...
                        echo CHtml::dropDownList('kecamatan_select', '3528010', $type_list, array('class' => 'kecamatan_select form-control selectpicker show-tick wajib-isi', 'data-live-search' => 'true', 'data-size' => '5', 'onchange' => 'selectKecamatan()', 'empty' => ''));
                        ?>
                        ...
                        echo CHtml::dropDownList('kelurahan_select', '3528010001', $type_list, array('class' => 'kelurahan_select form-control selectpicker show-tick wajib-isi', 'data-live-search' => 'true', 'data-size' => '5', 'empty' => ''));
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-5 no-margin no-padding">
                            ...
                            ?>
                            <?php // echo CHtml::textField('merk', '', array('class' => 'form-control wajib-isi text-besar')) 
                            ?>
                        </div>
                        <div class="col-md-1 no-margin no-padding"></div>
                        <div class="col-md-6 no-margin no-padding">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <div class="col-md-4 no-margin no-padding">
                            ...
                            echo CHtml::dropDownList('konfigurasi_sumbu', '', $type_list, array('class' => 'form-control wajib-isi'));
                            ?>
                        </div>
