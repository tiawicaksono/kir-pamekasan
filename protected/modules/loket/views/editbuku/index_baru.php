        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="col-md-12">
                    ...
                    <label for="nomer_sertifikasi_uji_baru">Nomor Rekomendasi Numpang Uji Masuk</label>
                    ...
                    <label for="nomer_sertifikasi_rancang_baru">Nomor Sertifikat Rancang Bangun / Uji Tipe</label>
        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                <div class="col-md-4">
                    ...
                    <?php echo CHtml::textField('alamat_pemilik_baru', '', array('class' => 'form-control text-besar')) ?>
                    ...
                    <label for="propinsi_baru">Propinsi</label>
                    <?php // echo CHtml::textField('propinsi_baru', 'JAWA TIMUR', array('class' => 'form-control text-besar')) 
                    ?>
                    <?php
                    ...
                    ?>
                    <label for="kota_baru">Kota</label>
                    <?php // echo CHtml::textField('kota_baru', 'PAMEKASAN', array('class' => 'form-control text-besar', 'onkeyup' => 'cekKecamatanBaru()')) 
                    ?>
                    <?php
                    ...
                    echo CHtml::dropDownList('kota_select_baru', '3528', $type_list, array('class' => 'kota_select_baru form-control selectpicker show-tick wajib-isi', 'data-live-search' => 'true', 'data-size' => '5', 'onchange' => 'selectKotaBaru()'));
                    ?>
                    <label for="kecamatan_baru">Kecamatan</label>
                    <?php
                    $criteria_kecamatan = new CDbCriteria();
                    $criteria_kecamatan->addCondition("id_kota = '3528'");
                    ...
                    echo CHtml::dropDownList('kecamatan_select_baru', '3528010', $type_list, array('class' => 'kecamatan_select_baru form-control selectpicker show-tick wajib-isi', 'data-live-search' => 'true', 'data-size' => '5', 'onchange' => 'selectKecamatanBaru()'));
                    ?>
                    ...
                    $criteria_kelurahan->addCondition("id_kecamatan = '3528010'");
                    ...
                    echo CHtml::dropDownList('kelurahan_select_baru', '3528010001', $type_list, array('class' => 'kelurahan_select_baru form-control selectpicker show-tick wajib-isi', 'data-live-search' => 'true', 'data-size' => '5')); ?>
                    <?php // echo CHtml::dropDownList('kelurahan_select_baru', '', array(''), array('class' => 'kelurahan_select_baru form-control selectpicker show-tick wajib-isi', 'data-live-search' => 'true', 'data-size' => '5')); 
                    ?>
                </div>
                <div class="col-md-4">
                    <div class="col-md-7 no-margin no-padding">
                    ...
                    <div class="col-md-4 no-margin no-padding">
                        ...
                        <?php echo CHtml::textField('tahun_baru', '', array('class' => 'form-control text-besar', 'maxlength' => 4, 'size' => 4)) ?>
                    </div>
                    <label for="nomer_mesin_baru">Nomor Mesin</label>
                    <?php echo CHtml::textField('nomer_mesin_baru', '', array('class' => 'form-control text-besar')) ?>
                    <label for="nomer_chasis_baru">Nomor Chasis</label>
                    <?php echo CHtml::textField('nomer_chasis_baru', '', array('class' => 'form-control text-besar')) ?>
                    <div class="col-md-5 no-margin no-padding">
                    ...
                    <div class="col-md-5 no-margin no-padding">
                        ...
                        ?>
                        <?php // echo CHtml::textField('merk_baru', '', array('class' => 'form-control wajib-isi text-besar')) 
                        ?>
                    </div>
                    <div class="col-md-1 no-margin no-padding"></div>
                    <div class="col-md-6 no-margin no-padding">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="input-group">
                            <?php echo CHtml::textField('isi_silinder_baru', '', array('class' => 'form-control text-besar')) ?>
                            <span class="input-group-addon">(cc)</span>
                        </div>
                        <label for="daya_motor_baru">Daya Motor</label>
                        <div class="input-group">
                            <?php echo CHtml::textField('daya_motor_baru', '', array('class' => 'form-control text-besar')) ?>
            ...
            <div class="col-md-12 no-padding">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="input-group">
                            <?php echo CHtml::textField('panjang_muatan_baru', '', array('class' => 'form-control text-besar')) ?>
                            <span class="input-group-addon">(mm)</span>
                        </div>
                        <label for="lebar_muatan_baru">Lebar</label>
                        <div class="input-group">
                            <?php echo CHtml::textField('lebar_muatan_baru', '', array('class' => 'form-control text-besar')) ?>
                            <span class="input-group-addon">(mm)</span>
                        </div>
                        <label for="tinggi_muatan_baru">Tinggi</label>
                        <div class="input-group">
                            <?php echo CHtml::textField('tinggi_muatan_baru', '', array('class' => 'form-control text-besar')) ?>
                            <span class="input-group-addon">(mm)</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 no-padding">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        ...
                        <div class="input-group">
                            <?php echo CHtml::textField('kebelakang_baru', '', array('class' => 'form-control text-besar')) ?>
                            <span class="input-group-addon">(mm)</span>
                        </div>
                        <label for="kedepan_baru">Ke Depan (FOH)</label>
                        <div class="input-group">
                            <?php echo CHtml::textField('kedepan_baru', '', array('class' => 'form-control text-besar')) ?>
                            <span class="input-group-addon">(mm)</span>
                        </div>
                        <label for="jarak_terendah_baru">Jarak Terendah</label>
                        <div class="input-group">
                            <?php echo CHtml::textField('jarak_terendah_baru', '', array('class' => 'form-control text-besar')) ?>
                            <span class="input-group-addon">(mm)</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="col-md-4 no-margin no-padding">
                        ...
                        echo CHtml::dropDownList('konfigurasi_sumbu_baru', '', $type_list, array('class' => 'form-control wajib-isi'));
                        ?>
                    </div>
