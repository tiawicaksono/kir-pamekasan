                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select size="1" class="form-control" id="jnsbody">
                                                ...
                                                <?php
                                                $queryNamaKomersil = "select * from v_kar_jenis";
                                                $resultNamaKomersil = Yii::app()->db->createCommand($queryNamaKomersil)->queryAll();
                                                foreach ($resultNamaKomersil as $dataNamaKomersil) {
                                                    echo "<option values=" . $dataNamaKomersil['karoseri_jenis'] . ">" . $dataNamaKomersil['karoseri_jenis'] . "</option>";
                                                };
                                                ?>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select size="1" class="ui-state-default" id="jnsbody">
                                                <option value="">Pilih Item</option>                       
                                                <?php
                                                $queryKarBahan = "select * from v_kar_bahan";
                                                $resultKarBahan = Yii::app()->db->createCommand($queryKarBahan)->queryAll();
                                                foreach ($resultKarBahan as $dataKarBahan) {
                                                    echo "<option values=" . $dataKarBahan['karoseri_bahan'] . ">" . $dataKarBahan['karoseri_bahan'] . "</option>";
                                                };
                                                ?>
                                            </select>
                                        </td>
