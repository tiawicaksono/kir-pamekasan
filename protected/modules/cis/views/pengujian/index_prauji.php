        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="col-lg-12 col-md-12 no-padding" style="margin-top: 20px">
                    ...
                    <table id="praujiListGrid" style="max-height:500px;"></table>
                    <div class="col-lg-12 col-md-12">
                        <div class="row">
                            <form id="formUpload" class="form-horizontal" name="formUpload" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="id_kendaraan_prauji" id="id_kendaraan_prauji" readonly="readonly" />
    ...
    <div class="col-md-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <div class="row" style="margin-bottom: 20px">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            ...
                            <button type="button" class="btn btn-success" onclick="captureCamera()"><span class="glyphicon glyphicon-camera"></span> CAPTURE</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 tengah">
                    <b style="font-size:15pt;">CAPTURE FOTO</b>
                </div>
                <div class="row" style="margin-bottom:20px;">
                    <div class="col-md-6 tengah">
                        <div class="col-md-6 col-sm-6 col-xs-12 no-padding tengah">
                            <img id="img_depan" style="height:200px" />
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 no-padding tengah">
                            <img id="img_belakang" style="height:200px" />
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 no-padding tengah">
                            <img id="img_kanan" style="height:200px" />
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 no-padding tengah">
                            <img id="img_kiri" style="height:200px" />
                        </div>
                    </div>
                    <div class="col-md-6 tengah">
                        <div class="col-md-6 col-sm-6 col-xs-12 no-padding tengah">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>5. Warna kendaraan tidak sesuai dengan STNK</td>
                                        <td>
                                            <label>
                                                <input id="a5" type="checkbox" class="flat-red"> Ya
                                            </label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                            ...
                            <div class="tab-pane" id="tab_2">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>9. Warna / Jenis lampu tidak sesuai</td>
                                        <td>
                                            <label>
                                                <input id="b11a" type="checkbox" class="flat-red"> L. Utama
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="b11b" type="checkbox" class="flat-red"> L. Penunjuk Arah
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="b11c" type="checkbox" class="flat-red"> L. Rem
                                            </label>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input id="b11d" type="checkbox" class="flat-red"> L. Posisi
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="b11e" type="checkbox" class="flat-red"> L. Tanda Batas
                                            </label>
                                        </td>
                                        <td colspan="2">&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>10. Lampu tertutup sticker / lainnya</td>
                                        <td>
                                            <label>
                                                <input id="b12a" type="checkbox" class="flat-red"> L. Utama
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="b12b" type="checkbox" class="flat-red"> L. Penunjuk Arah
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="b12c" type="checkbox" class="flat-red"> L. Rem
                                            </label>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input id="b12d" type="checkbox" class="flat-red"> L. Posisi
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="b12e" type="checkbox" class="flat-red"> L. Tanda Batas
                                            </label>
                                        </td>
                                        <td colspan="2">&nbsp;</td>
                                    </tr>
                            ...
                            <div class="tab-pane" id="tab_3">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input id="c5" type="checkbox" class="flat-red"> Rusak / Keropos
                                            </label>
                                        </td>
                                        <td colspan="3">&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>9. Kondisi kaca tidak sesuai / tidak ada</td>
                                        <td>
                                            <label>
                                                <input id="c20a" type="checkbox" class="flat-red"> Depan
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="c20b" type="checkbox" class="flat-red"> Belakang
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="c20c" type="checkbox" class="flat-red"> Kanan
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="c20d" type="checkbox" class="flat-red"> Kiri
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>10. Tutup tangki bahan bakar</td>
                                        <td>
                                            <label>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select size="1" class="form-control" id="jnsbody">
                                                ...
                                                <?php
                                                $queryNamaKomersil = "select * from tbl_kar_jenis order by kar_jenis asc";
                                                $resultNamaKomersil = Yii::app()->db->createCommand($queryNamaKomersil)->queryAll();
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select size="1" class="form-control ui-state-default" id="jnsbahan">
                                                <option value="">Pilih Item</option>
                                                <?php
                                                $queryKarBahan = "select * from tbl_kar_bahan order by kar_bahan asc";
                                                $resultKarBahan = Yii::app()->db->createCommand($queryKarBahan)->queryAll();
                                    ...
                                    <tr>
                                        <td>18. Kondisi body</td>
                                        <td>
                                            <label>
                                                <input id="c17" type="checkbox" class="flat-red"> Rusak / Keropos
                                            </label>
                                        </td>
                                        <td colspan="3">&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input id="c21" type="checkbox" class="flat-red"> Tidak ada
                                            </label>
                                        </td>
                                        <td colspan="3">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>21. Kondisi kaca tertutup stiker atau lainnya</td>
                                        <td>
                                            <label>
                                                <input id="c22a" type="checkbox" class="flat-red"> Depan
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="c22b" type="checkbox" class="flat-red"> Belakang
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="c22c" type="checkbox" class="flat-red"> Kanan
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input id="c22d" type="checkbox" class="flat-red"> Kiri
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>22. Alat Pemantul Cahaya (Reflektor)</td>
                                        <td colspan="4">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>- Tidak Ada</td>
                                        ...
                                        <td>
                                            <label>
                                                <input id="b9c" type="checkbox" class="flat-red"> Belakang
                                            </label>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input id="b10c" type="checkbox" class="flat-red"> Belakang
                                            </label>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
