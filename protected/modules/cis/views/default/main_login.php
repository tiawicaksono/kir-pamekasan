...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo Yii::app()->baseUrl; ?>/images/dishub.ico" type="image/x-icon"> 
    ...
    <body>
        ...
        <div id="login">
            ...
            <div class="inner">
                <div class="logo">
                    <img src="<?php echo Yii::app()->baseUrl; ?>/images/logo_dishub.png" width="120px" />
                </div>
