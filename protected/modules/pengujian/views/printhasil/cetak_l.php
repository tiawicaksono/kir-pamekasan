        ...
        <div class="pages">
            ...
            if ($posisi == 'kiri') {
                ...
                <div class="kolom_kiri">
                    <div id="konten_kiri">
                        <div class="kolom_hasil_uji">
                            <div class="total_gaya_pengereman"><?php echo $data->beratgaya; ?></div>
			    ...
			    <div class="lulus">LULUS</div>
                            <div class="lokasi">PAMEKASAN</div>
                            <div class="tgl_uji"><?php echo date('d') . " " . Yii::app()->params['blnArrayInd'][date('n') - 1] . " " . date('Y'); ?></div>
