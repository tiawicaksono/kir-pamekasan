...
<div class="pages">
    ...
    // BUAT NAMPILIN FOTO KENDARAAN
    $criteriaHasilUji = new CDbCriteria();
    $criteriaHasilUji->addCondition('id_kendaraan = ' . $dataKendaraan->id_kendaraan);
    $criteriaHasilUji->order = "id_hasil_uji DESC";
    $dataHasilUji = TblHasilUji::model()->find($criteriaHasilUji);
    ?>
    <table id="table_luar">
        <!--1-->
        <tr>
...
<div class="pages" style="margin-top:20px;">
    <table id="table_luar">
        ...
        <?php
        if (empty($dataHasilUji->img_depan)) {
        ?>
            <tr>
                <td colspan="4" class="center" style="height:40px;">&nbsp;</td>
                <td colspan="3" class="center">&nbsp;</td>
    ...
    ?>
        <table id="table_luar">
            <tr>
                <td><?php echo '<img src="data:image/jpeg;base64,' . $dataHasilUji->img_depan . '" width="100%"'; ?></td>
                <td><?php echo '<img src="data:image/jpeg;base64,' . $dataHasilUji->img_belakang . '" width="100%"'; ?></td>
                <td><?php echo '<img src="data:image/jpeg;base64,' . $dataHasilUji->img_kanan . '" width="100%"'; ?></td>
                <td><?php echo '<img src="data:image/jpeg;base64,' . $dataHasilUji->img_kiri . '" width="100%"'; ?></td>
            </tr>
        </table>
    <?php } ?>
</div>
