                ...
                <div class="col-lg-12 col-md-12 no-padding">
                    <div class="col-lg-2 col-md-2">
                        <div class="input-group">
                            ...
                            <?php echo CHtml::textField('tgl_search', date('d-M-Y'), array('readonly' => 'readonly', 'class' => 'tgl_search form-control')); ?>
                        </div>
                    </div>
                        ...
                        <div class="input-group">
                            <span class="input-group-btn">
                                <select class="btn" id="select_category">
                                    <option selected="selected" value="numerator">Numerator</option>
                                    <option value="no_kend_uji">No Uji / Kend.</option>
                                </select>
                            </span>
...
<script>
    $('#praujiListGrid').datagrid({
        url: '<?php echo $this->createUrl('Pemeriksaan/ListGrid'); ?>',
        pagination: true,
        singleSelect: true,
        selectOnCheck: true,
        checkOnSelect: true,
