...
function getInformationPrauji() {
  ...
  //    $.ajax({
  //        type: 'POST',
  //        url: 'Pemeriksaan/LoadImage',
  //        data: {idkendaraan: id_kendaraan},
  //        dataType: 'JSON',
  //        success: function (data) {
  //            $("#img3").attr('src','data:image/jpeg;base64,'+data[0].image1);
  //            $("#img4").attr('src','data:image/jpeg;base64,'+data[0].image2);
  //            $("#img1").attr('src','data:image/jpeg;base64,'+data[1].image1);
  //            $("#img2").attr('src','data:image/jpeg;base64,'+data[1].image2);
  //        }
  //    });
}
        ...
        if (r) {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              $("#replace_file").load("Pemeriksaan/ReplaceFile");
              return false;
            },
            error: function () {
              hidelargeloader();
