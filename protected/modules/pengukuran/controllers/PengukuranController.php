...
class PengukuranController extends Controller {
    ...
    public function actionPengukuranListGrid() {
        ...
        foreach ($result as $p) {
            $dataKend = VKendaraan::model()->findByAttributes(array('id_kendaraan' => $p->id_kendaraan));
            $dataJson[] = array(
                "id_hasil_uji" => $p->id_hasil_uji,
                "no_antrian" => $p->no_antrian,
                "no_uji" => $p->no_uji,
                "no_kendaraan" => $p->no_kendaraan,
                "jenis" => $dataKend->jenis,
                "nama_pemilik" => $dataKend->nama_pemilik,
                "alamat" => $dataKend->alamat
            );
        }
    ...
    public function actionDetailPengukuran() {
        ...
        $data['selgaya'] = $dataHasilUji->selgaya;
        $data['selkirikanan'] = $dataHasilUji->selkirikanan;
    ...
    public function actionSaveForm() {
        ...
        if (!in_array($id_jns_kend, array(4, 5))) {
            ...
            $sqlSmoke = "select update_smoke('$variabelSmoke',$id_hasil_uji,'$username')";
            ...
            $sqlLampu = "select update_lampu('$variabelLampu',$id_hasil_uji,'$username');";
        ...
        $sqlBrake = "select update_break('$variabelBrake',$id_hasil_uji,'$username');";
