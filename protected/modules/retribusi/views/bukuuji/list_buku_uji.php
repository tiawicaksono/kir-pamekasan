    ...
    <div class="col-lg-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title"><b>Kartu Uji</b></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
...
<div id="dlg_no_seri" class="easyui-dialog" title="Edit Kelulusan" style="width: 400px; height: auto; padding: 10px;display: none" data-options="
     iconCls: 'icon-save',
     autoOpen: false,
     buttons: [{
     text:'Ok',
...
<div id="dlg_no_seri_per_kendaraan" class="easyui-dialog" title="Edit Kelulusan" style="width: 400px; height: auto; padding: 10px;display: none" data-options="
     iconCls: 'icon-save',
     autoOpen: false,
     buttons: [{
     text:'Ok',
...
<div id="dlg_detail_buku" class="easyui-dialog" title="Cetak Kartu Uji" style="width: 900px; height: 600px; padding: 10px;display: none; overflow-x: hidden;" data-options="
     iconCls: 'icon-print',
     autoOpen: false,
     buttons: [{
     text:'Print',
...
<script>
    ...
    function buttonBukuUji(value) {
        ...
        var button = '<button type="button" data-toggle="tooltip" title="Kartu Uji" class="btn btn-success" onclick="printBukuUji(' + id_retribusi + ',\'' + no_seri + '\',\'' + tgl_cetak + '\')"><span class="glyphicon glyphicon-print"></span></button>';
        var urlAct = '<?php echo $this->createUrl('Bukuuji/DetailBukuUji'); ?>';
        var buttonview = '<button type="button" data-toggle="tooltip" title="Kartu Uji" class="btn btn-warning" onclick="buttonDetailBuku(\'' + urlAct + '\', ' + id_retribusi + ',\'' + value + '\')"><span class="fa fa-book"></span></button>';
    ...
    //        var no_seri = explode[1];
    //        var tgl_cetak = explode[2];
    //        var button = '<button type="button" data-toggle="tooltip" title="Kartu Uji" class="btn btn-success" onclick="printBukuUjiPerKendaraan(' + id_retribusi + ',\'' + no_seri + '\',\'' + tgl_cetak + '\')"><span class="glyphicon glyphicon-print"></span></button>';
    //        var urlAct = '<?php echo $this->createUrl('Bukuuji/DetailBukuUji'); ?>';
    //        var buttonview = '<button type="button" data-toggle="tooltip" title="Kartu Uji" class="btn btn-warning" onclick="buttonDetailBuku(\'' + urlAct + '\', ' + id_retribusi + ',\'' + value + '\')"><span class="fa fa-book"></span></button>';
    //        return button + " " + buttonview;
    //    }
