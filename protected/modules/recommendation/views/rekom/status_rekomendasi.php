                ...
                <section class="col-md-3">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <?php // echo CHtml::textField('no_surat_mutke', '', array('class' => 'form-control text-besar', 'readonly' => true)); 
                            ?>
                ...
                <section class="col-md-3">
                    ...
                    <div class="row">
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                <!--<label for="no_surat">No Surat</label>-->
                                <?php // echo CHtml::textField('no_surat_ubah_sifat', '', array('class' => 'form-control text-besar', 'readonly' => true)); 
                                ?>
                                <label for="propinsi">Keterangan</label>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 no-padding">
        <div class="col-lg-12 col-md-12 col-sm-12 no-padding" style="margin-bottom: 10px;">
            ...
            <select id="choose_tandatangan" class="form-control">
                <?php
                $tandatangan = TblKepalaDinas::model()->findAll();
                foreach ($tandatangan as $ttd) :
                ?>
                    <option value="<?php echo $ttd->id_kepala_dinas; ?>">
                        <?php echo $ttd->nama; ?>
                    </option>
                <?php endforeach; ?>
            </select>
