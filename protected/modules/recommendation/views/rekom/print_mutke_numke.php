<html lang="en">
    ...
    <body>
        <div class="pages watermarked">
            ...
            <div id="header2">
                <div id="sebelah_kiri">
                    <table>
                        <tr>
                            <td>Nomor</td>
                            <td> : </td>
                            <td>551.23/<?php echo ($id_uji == 5)?$dataRekom->no_surat_mutke:$dataRekom->no_surat_numke; ?>/<?php echo ($id_uji == 5) ? 'MTS' : 'NPU'; ?>/432.313/<?php echo date('Y'); ?></td>
                        </tr>
                        <tr>
                            <td>Sifat</td>
                            <td> : </td>
                ...
                <div id="sebelah_kanan">
                    <table style="margin-left: 120px;">
                        ...
                        <tr><td>&nbsp;</td></tr>
                        <tr><td>Kepada,</td></tr>
                        <tr><td>Yth. Kepala Dinas Perhubungan</td></tr>
                        <tr><td><?php echo ucwords(strtolower($mKota->nama)); ?></td></tr>
                        <tr><td>di,</td></tr>
                        <tr><td><b><u><?php echo ucwords(strtolower($mKota->nama)); ?></u></b></td></tr>
                    </table>
                </div>
            </div>
            <p>&nbsp;</p>
            ...
            <?php } else { ?>
                <div style="margin-left: 70px; margin-bottom: 10px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kendaraan tersebut diatas belum pernah uji di PAMEKASAN</div>
            <?php } ?>
            ...
            <?php } else { ?>
                <div style="margin-left: 70px; margin-bottom: 10px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sesuai dengan permohonan pemilik, 
                    ...
                    untuk satu kali uji dan hasil pengujiannya segera dikirim ke Dinas Perhubungan Kabupaten Pamekasan, Jawa Timur</div>
            <?php } ?>
