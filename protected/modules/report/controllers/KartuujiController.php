...
class KartuujiController extends Controller
{
    ...
    public function actionRekap($tgl)
    {
        ...
        //        $criteria->addCondition("tgluji >= TO_DATE('" . $tgl_awal_search . "', 'DDMMYY')");
        //        $criteria->addCondition("tgluji <= TO_DATE('" . $tgl_akhir_search . "', 'DDMMYY')");
        $criteria->addCondition("tgluji >= '$tgl_awal_search'");
        $criteria->addCondition("tgluji <= '$tgl_akhir_search'");
        ...
        foreach ($result as $data) :
            ...
            $sheet->setCellValue("G" . $baris, $data->tgluji);
