...
class TlController extends Controller
{
    ...
    {
        $this->pageTitle = 'REKAP TIDAK LULUS';
        $this->render('index');
    }
    ...
    public function actionRekap($tgl)
    {
        ...
        $sheet->setCellValue("A2", "PENGUJIAN KENDARAAN BERMOTOR KABUPATEN PAMEKASAN");
        ...
        $sheet->setCellValue("F5", "KENDARAAN");
        ...
        $sheet->setCellValue("G5", "TANDA TANGAN");
        ...
        $criteria->addCondition("tgl_uji >= TO_DATE('" . $tglAwal . "', 'DD/MM/YY')");
        $criteria->addCondition("tgl_uji <= TO_DATE('" . $tglAkhir . "', 'DD/MM/YY')");
        ...
        header('Content-Disposition: attachment;filename="REPORT-TIDAK LULUS.xls"');
