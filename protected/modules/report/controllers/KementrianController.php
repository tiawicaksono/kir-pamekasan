...
class KementrianController extends Controller
{
     ...
     */
         ...
         */
                ...
                $sheet->setCellValue("A3", "DINAS PERHUBUNGAN KABUPATEN PAMEKASAN, JAWA TIMUR");
         ...
         */
                ...
                header('Content-Disposition: attachment;filename="KEMENTRIAN BERKALA 3500 ' . $bln . '_' . $thn . '.xls"');
         ...
         */
                ...
                header('Content-Type: application/vnd.ms-excel');
                header('Content-Disposition: attachment;filename="KEMENTRIAN BERKALA L-TL ' . $bln . '_' . $thn . '.xls"');
                header('Set-Cookie: fileDownload=true; path=/');
                header('Cache-Control: max-age=0');
                header('Cache-Control: max-age=1');
         ...
         */
                ...
                header('Content-Type: application/vnd.ms-excel');
                header('Content-Disposition: attachment;filename="KEMENTRIAN BERKALA 3501-6000 ' . $bln . '_' . $thn . '.xls"');
                header('Set-Cookie: fileDownload=true; path=/');
                header('Cache-Control: max-age=0');
                header('Cache-Control: max-age=1');
         ...
         */
                ...
                header('Content-Type: application/vnd.ms-excel');
                header('Content-Disposition: attachment;filename="KEMENTRIAN BERKALA 6001-9000 ' . $bln . '_' . $thn . '.xls"');
                header('Set-Cookie: fileDownload=true; path=/');
                header('Cache-Control: max-age=0');
                header('Cache-Control: max-age=1');
         ...
         */
                ...
                header('Content-Type: application/vnd.ms-excel');
                header('Content-Disposition: attachment;filename="KEMENTRIAN BERKALA 9001-12000 ' . $bln . '_' . $thn . '.xls"');
                header('Set-Cookie: fileDownload=true; path=/');
                header('Cache-Control: max-age=0');
                header('Cache-Control: max-age=1');
         ...
         */
                ...
                header('Content-Type: application/vnd.ms-excel');
                header('Content-Disposition: attachment;filename="KEMENTRIAN BERKALA 12000 ' . $bln . '_' . $thn . '.xls"');
                header('Set-Cookie: fileDownload=true; path=/');
                header('Cache-Control: max-age=0');
                header('Cache-Control: max-age=1');
     ...
     */
         ...
         */
                ...
                $sheet->getColumnDimension("A")->setWidth(5);
                //=====================================================================================================
                $sheet->setCellValue("B6", "JENIS KEND / KENDARAAN");
                $sheet->getStyle("B6")->getAlignment()->setWrapText(true);
                $sheet->getStyle("B6")->getAlignment()->applyFromArray(array('horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER));
                $sheet->getStyle("B6")->getAlignment()->applyFromArray(array('vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER));
                $sheet->getStyle("B")->getAlignment()->applyFromArray(array('vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER));
         ...
         */
                ...
                foreach ($dataKendaraan as $data) :
                        ...
                        $sheet->setCellValue("B" . $baris, $data->jenis . " / " . $data->nm_komersil);
                ...
                header('Content-Type: application/vnd.ms-excel');
                header('Content-Disposition: attachment;filename="KEMENTRIAN UJI PERTAMA ' . $bln . '_' . $thn . '.xls"');
                header('Set-Cookie: fileDownload=true; path=/');
                header('Cache-Control: max-age=0');
                header('Cache-Control: max-age=1');
     ...
     */
         ...
         */
                ...
                //======================================================================
                $sheet->setCellValue("E7", "MOBIL KHUSUS");
         ...
         */
                ...
                for ($bln = 1; $bln <= 12; $bln++) :
                        ...
                        //======================================================================
                        $sqlKhusus = "SELECT count(*) AS total FROM v_kementrian_kbwu vrkt "
                                . "LEFT OUTER JOIN tbl_jns_kend b ON (vrkt.id_jns = b.id_jns_kend) "
                                . "WHERE vrkt.bulan = " . $bln . " ::double precision AND vrkt.tahun = " . $tahun . " ::double precision AND id_jns = 3";
                        $dataKhusus = Yii::app()->db->createCommand($sqlKhusus)->queryRow();
                        //======================================================================
                        ...
                        $sheet->setCellValue("E" . $baris, $dataKhusus['total']);
                ...
                $sheet->getStyle("A6:H" . $baris)->applyFromArray($styleBorder);
                $sheet->getStyle("A" . $baris . ":H" . $baris)->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB('b3c6cf');
                //======================================================================
                ob_clean();

                header('Content-Type: application/vnd.ms-excel');
                header('Content-Disposition: attachment;filename="KEMENTRIAN KBWU ' . $thn . '.xls"');
                header('Set-Cookie: fileDownload=true; path=/');
                header('Cache-Control: max-age=0');
                header('Cache-Control: max-age=1');
