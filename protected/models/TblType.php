...
class TblType extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('mst1', 'numerical', 'integerOnly' => true),
            array('warna, isi_silinder, daya_motor, bahan_bakar, ukuran_panjang, ukuran_lebar, ukuran_tinggi, bagian_belakang, bagian_depan, bagian_jterendah, karoseri_jenis, karoseri_bahan, karoseri_duduk, karoseri_berdiri, jsumbu1, jsumbu2, jsumbu3, jsumbu4, bsumbu1, bsumbu2, bsumbu3, bsumbu4, bsumbu5, psumbu1, psumbu2, psumbu4, psumbu5, psumbu3, dimpanjang, dimlebar, dimtinggi, kemjbb, kemjbkb, kemorang, kembarang, kls_jln, ukp, ukq, ukp2, konsumbu, dydukpab1, dydukpab2, dydukpab3, dydukpab4, dydukpab5, stts_kirim', 'length', 'max' => 30),
    ...
    public function search() {
        ...
        $criteria->compare('mst1', $this->mst1);
