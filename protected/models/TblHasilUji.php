 ...
 * @property integer $id_uptd
 * @property string $no_stuk
...
class TblHasilUji extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('no_antrian, alat, id_uji, id_uptd', 'numerical', 'integerOnly' => true),
            array('ktlamp_kanan, dev_kanan, dev_kiri, grem_sb1, grem_sb2, grem_sb3, grem_sb4, selrem_sb1, selrem_sb2, selgaya, selkirikanan, ems_diesel, ems_mesin_co, ems_mesin_hc, ktlamp_kiri, selrem_sb3, selrem_sb4, selgaya3, selgaya4', 'numerical'),
            array('nm_penguji, jabatan', 'length', 'max' => 50),
            array('no_surat, nrp, no_antrian1, status, no_stuk', 'length', 'max' => 30),
            array('keterangan', 'length', 'max' => 1000),
            array('posisi', 'length', 'max' => 10),
            array('stts_kirim', 'length', 'max' => 20),
            array('id_daftar, jdatang, jselesai, penyerahan, prauji, cetak, no_ujikend, no_casmesin, lp_arah, lp_rem, lp_mundur, lp_posisi, konbody, prisaikolong, ubansb1, ubansb2, alurban, kuatroda, uupanjang, uulebar, uutinggi, uufoh, uuroh, jssb12, dpanjang, dlebar, dtinggi, klipkcdepan, kcspion, dongkrak, peralatan, serep, tndsgtg, sabuk, ujimekanis, siskem, sissus, salrem, sisdaya, msntranmisi, tangki, salgasbuang, klakson, spedmeter, kincuproda, id_kendaraan, lulus_prauji, lulus_ujimekanis, stts_ant, pitlift, lulus_pitlift, smoke, lulus_smoke, lampu, lulus_lampu, break, lulus_break, uji_ulang, img1, img2, siap_uji, jproses', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id_hasil_uji, id_daftar, ktlamp_kanan, dev_kanan, dev_kiri, grem_sb1, grem_sb2, grem_sb3, grem_sb4, selrem_sb1, selrem_sb2, selgaya, selkirikanan, ems_diesel, ems_mesin_co, ems_mesin_hc, ktlamp_kiri, nm_penguji, no_antrian, jdatang, jselesai, penyerahan, no_surat, keterangan, prauji, cetak, no_ujikend, no_casmesin, lp_arah, lp_rem, lp_mundur, lp_posisi, konbody, prisaikolong, ubansb1, ubansb2, alurban, kuatroda, uupanjang, uulebar, uutinggi, uufoh, uuroh, jssb12, dpanjang, dlebar, dtinggi, klipkcdepan, kcspion, dongkrak, peralatan, serep, tndsgtg, sabuk, ujimekanis, siskem, sissus, salrem, sisdaya, msntranmisi, tangki, salgasbuang, klakson, spedmeter, kincuproda, selrem_sb3, selrem_sb4, id_kendaraan, alat, lulus_prauji, lulus_ujimekanis, nrp, jabatan, no_antrian1, stts_ant, id_uji, status, id_uptd, no_stuk, pitlift, lulus_pitlift, smoke, lulus_smoke, lampu, lulus_lampu, break, lulus_break, uji_ulang, img1, img2, siap_uji, posisi, stts_kirim, selgaya3, selgaya4, jproses', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('selgaya', $this->selgaya);
        $criteria->compare('selkirikanan', $this->selkirikanan);
        ...
        $criteria->compare('id_uptd', $this->id_uptd);
        $criteria->compare('no_stuk', $this->no_stuk, true);
        ...
        $criteria->compare('siap_uji', $this->siap_uji);
