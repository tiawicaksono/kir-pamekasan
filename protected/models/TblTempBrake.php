...
class TblTempBrake extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('grem_sb1, grem_sb2, selrem_sb1, selrem_sb2, grem_sb3, grem_sb4, selrem_sb3, selrem_sb4', 'numerical'),
			array('no_uji, no_kendaraan', 'length', 'max'=>20),
			array('cis', 'length', 'max'=>10),
			array('kelulusan, id_hasil_uji', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_temp_brake, no_uji, no_kendaraan, cis, grem_sb1, grem_sb2, selrem_sb1, selrem_sb2, kelulusan, id_hasil_uji, grem_sb3, grem_sb4, selrem_sb3, selrem_sb4', 'safe', 'on'=>'search'),
		);
	}
