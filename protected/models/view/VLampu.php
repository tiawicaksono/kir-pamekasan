...
/**
 * This is the model class for table "v_lampu".
 *
 * The followings are the available columns in table 'v_lampu':
 ...
 */
class VLampu extends CActiveRecord
{
	/**
	 ...
	 * @return VLampu the static model class
	 */
