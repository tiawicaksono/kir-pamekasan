...
/**
 * This is the model class for table "v_smoke".
 *
 * The followings are the available columns in table 'v_smoke':
 ...
 */
class VSmoke extends CActiveRecord
{
	/**
	 ...
	 * @return VSmoke the static model class
	 */
