...
/**
 * This is the model class for table "v_break1".
 *
 * The followings are the available columns in table 'v_break1':
 ...
 */
class VBreak1 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('no_antrian, stts_no, id_hasil_uji, id_daftar, prauji, cetak, no_kendaraan, no_uji, nama_pemilik, keterangan, id_jns_kend, merk, tahun, tipe, konsumbu, bahan_bakar, nm_komersil, bsumbu1, bsumbu2, bsumbu3, bsumbu4', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VBreak1 the static model class
	 */
