...
class VUjiMekanisAll extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ktlamp_kanan, ktlamp_kiri, dev_kanan, dev_kiri, selrem_sb1, selrem_sb2, selrem_sb3, selrem_sb4, selgaya, selkirikanan, ems_diesel, ems_mesin_co, ems_mesin_hc, selgaya3, selgaya4', 'numerical'),
			...
			array('id_hasil_uji, lulus_prauji, no_kendaraan, nama_pemilik, alamat, tahun, tipe, id_daftar, id_kendaraan, id_jns_kend', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ktlamp_kanan, ktlamp_kiri, dev_kanan, dev_kiri, selrem_sb1, selrem_sb2, selrem_sb3, selrem_sb4, selgaya, selkirikanan, ems_diesel, ems_mesin_co, ems_mesin_hc, nm_penguji, id_hasil_uji, lulus_prauji, no_uji, no_kendaraan, nama_pemilik, alamat, tahun, jns_kend, bsumbu1, bsumbu2, bsumbu3, bsumbu4, konsumbu, bahan_bakar, tipe, id_uji, id_daftar, alat, selgaya3, selgaya4, no_antrian, id_kendaraan, id_jns_kend', 'safe', 'on'=>'search'),
		);
	}
