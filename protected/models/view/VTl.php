...
class VTl extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('no_uji, bk_masuk', 'length', 'max'=>30),
			array('jns_kend', 'length', 'max'=>40),
			array('nm_uji', 'length', 'max'=>50),
			array('tgl_uji, no_berkas, nama_pemilik, no_kendaraan, no_chasis, no_mesin, id_kendaraan, id_daftar, id_retribusi, datang, id_uji, tgl_retribusi, numerator, cetak, jdatang', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tgl_uji, no_berkas, no_uji, nama_pemilik, no_kendaraan, no_chasis, no_mesin, id_kendaraan, id_daftar, id_retribusi, datang, jns_kend, nm_uji, id_uji, tgl_retribusi, numerator, bk_masuk, cetak, jdatang', 'safe', 'on'=>'search'),
		);
	}
