...
class VPrintHasil extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_uji', 'numerical', 'integerOnly'=>true),
			array('ktlamp_kanan, ktlamp_kiri, dev_kanan, dev_kiri, selrem_sb1, selrem_sb2, selrem_sb3, selrem_sb4, beratgaya, selgaya, selkirikanan, ems_diesel, ems_mesin_co, ems_mesin_hc', 'numerical'),
			array('nm_penguji, jabatan', 'length', 'max'=>50),
			array('no_surat, no_uji, tahun, no_mesin, no_chasis, jenis, merk, bahan_bakar, tipe, nrp', 'length', 'max'=>30),
			array('no_kendaraan', 'length', 'max'=>12),
			array('nama_pemilik', 'length', 'max'=>100),
			array('alamat', 'length', 'max'=>200),
			array('posisi', 'length', 'max'=>10),
			array('id_hasil_uji, ujimekanis, prauji, cetak, id_kendaraan, tgl_uji, id_daftar, jdatang, jselesai, no_antrian, stts_no, genap, lulus, uji_ulang', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_hasil_uji, ktlamp_kanan, ktlamp_kiri, dev_kanan, dev_kiri, selrem_sb1, selrem_sb2, selrem_sb3, selrem_sb4, beratgaya, selgaya, selkirikanan, ems_diesel, ems_mesin_co, ems_mesin_hc, nm_penguji, ujimekanis, prauji, cetak, no_surat, no_uji, no_kendaraan, nama_pemilik, tahun, no_mesin, no_chasis, jenis, merk, alamat, bahan_bakar, tipe, id_kendaraan, tgl_uji, nrp, jabatan, id_daftar, jdatang, jselesai, no_antrian, id_uji, stts_no, genap, lulus, posisi, uji_ulang', 'safe', 'on'=>'search'),
		);
	}
