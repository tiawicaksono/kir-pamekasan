...
class VRiwayatHasil extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('b_daftar, b_gnt_buku, b_tlt_uji, b_total, lama, ems_diesel, ems_mesin_co, ems_mesin_hc, ktlamp_kanan, ktlamp_kiri, dev_kanan, dev_kiri, selrem_sb1, selrem_sb2, selgaya, selkirikanan', 'numerical'),
