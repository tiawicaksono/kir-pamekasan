...
/**
 * This is the model class for table "v_break".
 *
 * The followings are the available columns in table 'v_break':
 ...
 */
class VBreak extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('no_kendaraan, no_uji, merk, tahun, tipe, bahan_bakar, bsumbu1, bsumbu2, bsumbu3, bsumbu4', 'length', 'max'=>30),
			...
			array('no_antrian, stts_no, id_hasil_uji, id_daftar, prauji, cetak, id_jns_kend', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('no_antrian, stts_no, id_hasil_uji, id_daftar, prauji, cetak, no_kendaraan, no_uji, nama_pemilik, keterangan, id_jns_kend, merk, tahun, tipe, konsumbu, bahan_bakar, nm_komersil, bsumbu1, bsumbu2, bsumbu3, bsumbu4, posisi', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VBreak the static model class
	 */
