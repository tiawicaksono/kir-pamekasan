...
/**
 * This is the model class for table "v_kelulusan".
 *
 * The followings are the available columns in table 'v_kelulusan':
 * @property string $id_kelulusan
 * @property string $kd_lulus
 * @property string $kelulusan
 */
class VKelulusan extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_kelulusan, kd_lulus', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_kelulusan, kd_lulus, kelulusan', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VKelulusan the static model class
	 */
