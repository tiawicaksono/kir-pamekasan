...
/**
 * This is the model class for table "v_pra_uji".
 *
 * The followings are the available columns in table 'v_pra_uji':
 ...
 */
class VPraUjiAll extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('no_uji, bahan_bakar, karoseri_bahan', 'length', 'max'=>30),
			array('karoseri_jenis, nm_komersil', 'length', 'max'=>100),
			array('konsumbu', 'length', 'max'=>12),
			array('keterangan', 'length', 'max'=>1000),
			array('nm_uji', 'length', 'max'=>50),
			array('id_kendaraan, id_hasil_uji, id_daftar, prauji, cetak, no_kendaraan, nama_pemilik, id_jns_kend, merk, tahun, tipe, img1, img2, jdatang', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('no_antrian, id_kendaraan, id_hasil_uji, id_daftar, prauji, cetak, no_kendaraan, no_uji, nama_pemilik, id_jns_kend, merk, tahun, tipe, antri, karoseri_jenis, bahan_bakar, nm_komersil, karoseri_bahan, konsumbu, img1, img2, keterangan, nm_uji, jdatang', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VPraUji the static model class
	 */
