 ...
 */
class VStatusProsesAll extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'v_status_proses_all';
    }
    ...
    public function rules() {
        ...
        return array(
            ...
            array('no_antrian, id_hasil_uji, id_daftar, id_kendaraan, prauji, lulus_prauji, smoke, lulus_smoke, pitlift, lulus_pitlift, lampu, lulus_lampu, break, lulus_break, hasil', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('no_antrian, id_hasil_uji, id_daftar, id_kendaraan, no_kendaraan, no_uji, nama_pemilik, prauji, lulus_prauji, smoke, lulus_smoke, pitlift, lulus_pitlift, lampu, lulus_lampu, break, lulus_break, ptgs_prauji, ptgs_smoke, ptgs_pitlift, ptgs_lampu, ptgs_break, posisi, hasil', 'safe', 'on' => 'search'),
        );
    }
