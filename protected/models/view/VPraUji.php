...
/**
 * This is the model class for table "v_pra_uji_v2".
 *
 * The followings are the available columns in table 'v_pra_uji_v2':
 ...
 */
class VPraUji extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('no_kendaraan, no_uji, merk, tahun, tipe, karoseri_jenis, bahan_bakar, karoseri_bahan', 'length', 'max'=>30),
			array('nama_pemilik, nm_komersil', 'length', 'max'=>100),
			array('keterangan', 'length', 'max'=>1000),
			array('konsumbu', 'length', 'max'=>12),
			array('no_antrian, stts_no, id_kendaraan, id_hasil_uji, id_daftar, prauji, cetak, id_jns_kend', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('no_antrian, stts_no, id_kendaraan, id_hasil_uji, id_daftar, prauji, cetak, no_kendaraan, no_uji, nama_pemilik, keterangan, id_jns_kend, merk, tahun, tipe, antri, karoseri_jenis, bahan_bakar, nm_komersil, karoseri_bahan, konsumbu', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VPraUjiV2 the static model class
	 */
