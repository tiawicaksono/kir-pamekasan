    ...
    <div class="col-md-12">
        ...
        <section class="col-lg-4">    
            <div class="box box-success">
                ...
                <div class="box-body no-padding" id="divDataKendaraan">
                    <?php
...
$(document).ready(function(){
    ...
    $("#divTotalRetribusi").load("<?php echo $this->createUrl('Site/A'); ?>")
    }, 2000);
    setInterval(function(){
    $("#total_kendaraan_atas").load("<?php echo $this->createUrl('Site/B'); ?>")
    }, 2000);
    setInterval(function(){
    $("#divDataKendaraan").load("<?php echo $this->createUrl('Site/C'); ?>")
    }, 2000);
});
</script>