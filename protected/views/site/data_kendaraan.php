<div class="table-responsive">
    <table class="table no-margin no-padding">
        ...
        <tbody>
			...
			<tr>
                <td>Mobil Khusus</td>
                <td align="center"><?php echo $mku = $mobilKhususU; ?></td>
                <td align="center"><?php echo $mkbu = $mobilKhususBu; ?></td>
                <td align="center"><?php echo $mku+$mkbu; ?></td>
            </tr>
			<tr>
                <td>Kereta Gandengan</td>
                <td align="center"><?php echo $kgU; ?></td>
                <td align="center"><?php echo $kgBu; ?></td>
                <td align="center"><?php echo $kgU+$kgBu; ?></td>
            </tr>
			<tr>
                <td>Kereta Tempelan</td>
                <td align="center"><?php echo $ktU; ?></td>
                <td align="center"><?php echo $ktBu; ?></td>
                <td align="center"><?php echo $ktU+$ktBu; ?></td>
            </tr>
<!--            <tr>
                <td>Mobil Taxi</td>
        ...
        <tfoot>
            <tr>
                ...
                <th style="text-align: center">
                    <?php
                    echo $totalUmum = $mbu + $mbisu + $mpu + $mku + $kgU + $ktU;
                    ?>
                </th>
                <th style="text-align: center">
                    <?php
                    echo $totalBUmum = $mbbu + $mbisbu + $mpbu + $mkbu + $kgBu + $ktBu;
                    ?>
                </th>
